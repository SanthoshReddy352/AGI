...
* **Playwright controlled Chromium** (preferred): a real, visible browser FRIDAY
...
def _engine() -> str:
    ...
    try:
        ...
        from friday.core.browser_controller import BrowserController
    ...
    with _controller_lock:
        if _controller is None:
            ...
            _controller = BrowserController(
                ...
                profile_dir=cfg.get("profile_dir", "~/.friday/browser-profile"),
...
def register(registry: ToolRegistry) -> None:
    ...
    registry.register(
        "media_control",
        "Control the currently playing video in FRIDAY's browser: play, pause, toggle, "
