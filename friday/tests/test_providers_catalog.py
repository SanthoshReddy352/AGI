...
from friday.core.providers.catalog import list_models, list_models_result, provider_catalog
...
def test_models_endpoint_returns_source(monkeypatch):
    ...
    import friday.core.providers.catalog as cat
