...
export default function Sidebar({ sessions, projects = [], onNew, onOpen, onDelete, onRename, onFile, onConfirm, onOpenSettings, collapsed, onToggle, name = "FRIDAY" }) {
  const [pinned, setPinned] = useState(() => localStorage.getItem("friday-sidebar-pinned") !== "false");
  ...
  function togglePin() {
    setPinned((p) => { localStorage.setItem("friday-sidebar-pinned", String(!p)); return !p; });
    onToggle?.();
  }
