...
Keyword BM25 over FTS5 keeps the whole stack inside FRIDAY's single SQLite file
...
def ingest_document(db, project_id: str, path: str, name: str = "") -> dict:
    ...
    from friday.tools.documents import extract_text  # late: optional deps inside
