"""Track applications FRIDAY opens, and tell whether they're still running.

Two jobs:
  * record what was launched (``data/opened_apps.json``) so FRIDAY knows what it
...
class AppTracker:
    ...
    def running(self) -> list[str]:
        """Names FRIDAY opened that are still running (also prunes dead ones)."""
        alive, changed = [], False
