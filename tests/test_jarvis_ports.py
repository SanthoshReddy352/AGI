...
class _FakeApp:
    ...
    # Track 4.1b: forward `register_capability` to `router.register_tool`
    # the same way `FridayApp.register_capability` does in production.
    # Subclasses inherit this; the fake is now fully API-compatible
    # whether plugins call the new or old entry point.
