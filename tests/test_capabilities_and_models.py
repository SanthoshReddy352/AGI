...
# `test_jarvis_skills_plugin_disables_missing_optional_skills` deleted
# 2026-05-19: it tested the `skills/` folder's optional-skill loading,
# which was removed along with the folder (the active plugin surface
# lives in `modules/`).
