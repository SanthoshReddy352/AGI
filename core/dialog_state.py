...
class DialogState:
    ...
    # Set when FRIDAY needs to disambiguate between multiple matching goals.
    pending_goal_selection: PendingGoalSelection | None = None
    ...
    def set_pending_goal_selection(self, candidates, tool, original_args=None):
        self.pending_goal_selection = PendingGoalSelection(
            candidates=list(candidates),
            tool=tool,
            original_args=original_args or {},
        )

    def clear_pending_goal_selection(self):
        self.pending_goal_selection = None

    def has_pending_goal_selection(self):
        return bool(self.pending_goal_selection and self.pending_goal_selection.candidates)
